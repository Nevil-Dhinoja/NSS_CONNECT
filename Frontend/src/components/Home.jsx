      ...
      <div className="mission-Page">
        ...
        <div className="DContainer">
          ...
          <div className="DutyDescription">
            <p>
             - To serve the community and uphold the values of NSS. To participate
              actively in community development programs. To foster leadership,
              teamwork, and problem-solving skills. To uphold ethical and moral
              responsibilities in all activities. To commit to social awareness
